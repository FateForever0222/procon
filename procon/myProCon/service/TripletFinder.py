...
from procon.myProCon.model import Triplet, MuiSite
...
class TripletFinder:
    ...
    def __init__(self, mi):
        ...
        print("Triplet Finder inited successfully")
    ...
    def display_triplets(self):
        ...
        for i in self.__tps:
            print("{}{}{}{}\n".format(str(count).ljust(7),
                                      (str(i.get_s1()) + seq[0][i.get_s1()]).ljust(7),
                                      (str(i.get_s2()) + seq[0][i.get_s2()]).ljust(7),
                                      (str(i.get_s3()) + seq[0][i.get_s3()]).ljust(7)))
            count += 1
    ...
    def show_graph(self, file):
        ...
        dot.render(filename=file, view=True)
